...
function echo (str) {
  ...
  let firstString = str.toUpperCase()
  //   let secondString = str.charAt(0).toUpperCase() + string.slice(1);
  let secondString = str.toLowerCase()
  let result = firstString + ' ... ' + str + ' ... ' + secondString
  return result
}
